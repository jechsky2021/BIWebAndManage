...
INSERT INTO `user` VALUES (1,'admin','CinA5MJWDvBTvOJSvluE4g==','13100000000','2026-01-21 11:25:37',NULL),(2,'test1','1jdzWuniG6UMtoa3T6uNLA==','13100000000','2026-01-23 16:29:23',NULL);
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `proc_login`(in uName varchar(100),in uPasswords varchar(100))
BEGIN

select 
u.id,u.uName,u.uPhone
from user u
where u.uName = uName and u.uPasswords = uPasswords;
...
select SQL_CALC_FOUND_ROWS u.id,u.uName,u.uPhone
 from user u
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `proc_selectWebArticleByPage`(in statuss int,in articleType bigint,in parentId bigint,in startTime varchar(255),in endTime varchar(255), in pageSize int,in pageNumber int)
BEGIN
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `proc_updateUser`(in id bigint,in uName varchar(100),in uPasswords varchar(100),in uPhone varchar(45))
BEGIN

update user u set u.uName = uName,u.uPasswords = uPasswords,u.uPhone = uPhone where u.id = id;
...
-- Dump completed on 2026-02-27  9:34:26
